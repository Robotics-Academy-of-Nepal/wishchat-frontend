    ...
    return (
        <div className="relative flex items-center justify-center min-h-screen overflow-hidden bg-gradient-to-r from-blue-600 via-purple-700 to-indigo-800">
            ...
            <div className="relative z-10 p-8 m-4 bg-white rounded-xl shadow-2xl w-[90%] max-w-lg lg:max-w-md bg-opacity-90 transform transition duration-300 hover:scale-105 hover:shadow-3xl">
                ...
                <p className="mt-3 mb-6 text-sm text-center text-gray-600">
                ...
                >
                    <div>
                        ...
                        <input
                            className="w-full px-4 py-3 text-sm text-gray-900 transition duration-300 bg-gray-100 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 hover:shadow-md"
                            type="text"
                            id="Username"
                            name="Username"
                    ...
                    <button
                        className="w-full py-3 text-sm font-semibold text-white transition duration-300 rounded-lg shadow-lg bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 hover:shadow-2xl focus:outline-none focus:ring-4 focus:ring-blue-400"
                        type="submit"
                    >
                        Sign In
                    </button>
